...
func init() {
	pages.BaseAddress = "http://localhost"
	pages.Templates = "_assets/templates/"
	...
	email.InitSMTP("postmaster@sandbox43c1aa137fa34dce91835dea6fcbafd7.mailgun.org", "uPig*P6Zgml*s6q", "smtp.mailgun.org", "465")
	...
	// Configures PayPal
	if pages.InitPayPal("AeMshfG7Rpy6zsw7GCREUBXi897HzkwuVshrf2BmYk2uU7Q4If3ax4AOJtaEqfU8lS-QymRuQYX0R9LL", "EIYSLuOY6B19Yqc_2tONbjOdhHxR15w166Pa3JxiEylZZn7ZSWC7SZtpSLbOJcLS9n7fs391hZ9XY6N6", true) != nil {
		panic(err)
	}
}
